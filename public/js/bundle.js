...
var showAlert = function showAlert(type, text) {
  hideAlert();
  var alertBox = "<div class=\"alert alert--".concat(type, "\">").concat(text, " </div>");
        ...
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            if (res.data.status === "success") {
              (0, _alert.showAlert)("success", "Welcome in Holidays !!!");
              setTimeout(function () {
                location.assign("/");
              }, 1000);
            }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 8:
            ...
            (0, _alert.showAlert)("error", _context2.t0.response.data.message); // setTimeout(() => {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 9:
            ...
            (0, _alert.showAlert)("error", _context4.t0.message);
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "PATCH",
              url: "http://localhost:5000/api/v1/users/resetPassword/".concat(resetToken),
              data: {
                password: password,
                passwordConfirm: passwordConfirm
              }
...
var showMap = function showMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<span>Day ".concat(loc.day, ": ").concat(loc.description, "</span>")).addTo(map);
...
var stripe = Stripe('pk_test_51I69ABBvUweAFj1LGJ81GeFgeBA82kEMUaJR5uEW6zsPRkFVTDoIx5DKsYYteYb9M5S2k7qOBNTja0Vc7InLlDpg000dexOfJO');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.get("http://localhost:5000/api/v1/booking/checkout-session/".concat(tourId));
...
var logoutButton = document.querySelector(".nav__el--logout"); // const signupButton = document.querySelector(".nav__el--cta");

if (mapBox) {
  var locations = JSON.parse(mapBox.dataset.locations); // console.log("map box integrated", locations);
...
if (resetPasswordForm) {
  resetPasswordForm.addEventListener("submit", function (e) {
    ...
    var resetToken = e.path[6].location.pathname.split("/")[2]; // console.log(resetToken);
